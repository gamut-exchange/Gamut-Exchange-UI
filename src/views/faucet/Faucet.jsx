        ...
        <div className="main-container">
          <div className="py-6 border-b border-grey-dark">
            ...
            <p className="desc-small">
              Here you can get Tokens to participate in the Testnet, make sure you also got some <a href="https://faucet.egorfine.com/" target="blank"><span className="text-light-primary text-lg">{selected_chain} Token</span></a> in your Wallet.
            </p>
          </div>
